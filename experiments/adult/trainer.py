...
def train(data_name, model_name, classes_per_node, num_nodes, steps, inner_steps, lr, inner_lr, wd, inner_wd, hyper_hid, n_hidden, bs, device, eval_every, alpha, fair):
    ...
    step_results, avg_loss, avg_acc, all_acc, all_loss, f1, f1_f, f1_m, f_a, m_a, aod, eod, spd = eval_model(nodes, num_nodes, hnet, model, loss, device, confusion=True,fair=fair, fair_loss = fair_loss)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--fair", type=str, default="dp", choices=["none", "eo", "dp"], help="whether to use fairness of not.")
