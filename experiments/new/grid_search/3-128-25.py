...
def train(writer, device, data_name,model_name,classes_per_node,num_nodes,steps,inner_steps,lr,inner_lr,wd,inner_wd, hyper_hid,n_hidden,bs, alpha,fair, which_position, context_hidden_size):
    ...
    save_file_name = "/home/ancarey/FairFLHN/experiments/new/grid_search/results/3_128_25.txt"
...
def main():
    ...
    file = open("/home/ancarey/FairFLHN/experiments/new/grid_search/results/3_128_25.txt", "w")
    file.close()
