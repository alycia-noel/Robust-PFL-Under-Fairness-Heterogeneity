...
def train(writer, device, data_name,model_name,classes_per_node,num_nodes,steps,inner_steps,lr,inner_lr,wd,inner_wd, hyper_hid,n_hidden,bs, alpha,fair, which_position):
    ...
    for i in range(1):
        ...
        for step in step_iter:
            ...
            #     step_results, avg_loss, avg_acc_all, all_acc, all_loss, f1, f1_f, f1_m, f_a, m_a, aod, eod, spd = eval_model(nodes, num_nodes, hnet, models, None, num_features, loss, device, confusion=False, fair=fair, constraint=constraints, alpha=alpha, which_position=which_position)
            #
...
def main():
    ...
    parser.add_argument("--alpha", type=int, default=[.5,40], help="fairness/accuracy trade-off parameter")
