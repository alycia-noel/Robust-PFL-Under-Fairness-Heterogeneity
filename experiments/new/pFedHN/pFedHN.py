...
def train(writer, device, data_name,model_name,classes_per_node,num_nodes,steps,inner_steps,lr,inner_lr,wd,inner_wd, hyper_hid,n_hidden,bs, alpha,fair, which_position):
    ...
    for step in step_iter:
        ...
        if step % 99 == 0 or step == 1499 or step == 0:
            step_results, avg_loss, avg_acc, all_acc, all_loss, f1, f1_f, f1_m, f_a, m_a, aod, eod, spd = eval_model(nodes, num_nodes, hnet, model, num_features, loss, device, confusion=False, fair=fair, constraint=constraint, alpha=alpha, which_position=which_position)
    ...
    step_results, avg_loss, avg_acc, all_acc, all_loss, f1, f1_f, f1_m, f_a, m_a, aod, eod, spd = eval_model(nodes,
                                                                                                             num_nodes,
                                                                                                             hnet,
                                                                                                             model,
                                                                                                             num_features,
