...
model = NN(input_size=9, vector_size=9)
model = model.double()
...
optimizer = torch.optim.Adam(model.parameters(), lr = .002, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.0000001)
...
for epoch in range(50): #original 250, best:700
