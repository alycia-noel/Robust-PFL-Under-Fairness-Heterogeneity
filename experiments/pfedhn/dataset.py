...
def get_datasets(data_name, dataroot, normalize, val_size):
    ...
    if data_name == 'COMPAS':
        ...
        train_set_1 = TabularData(d_train_1[features_1].values, d_train_1[decision_1].values, train=True, download=False, transform=None)
        ...
        train_set_2 = TabularData(d_train_2[features_2].values, d_train_2[decision_2].values, train=True, download=False, transform=None)
        ...
        return train_set_1, train_set_2, test_set_1, test_set_2
...
def gen_random_loaders(data_name, data_path, num_users, bz, classes_per_user):
    ...
    if data_name == 'COMPAS':
        dataloaders = []
        train_set_1, train_set_2, test_set_1, test_set_2 = datasets
