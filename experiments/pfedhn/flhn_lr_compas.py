...
# Train model
steps = 14 # so total inner train is times 700
place = 0
...
for step in range(steps):
    ...
    for epoch in range(50):
        ...
        print('Step: {5}/{6};\tEpoch: {0}/{1};\tLoss: {2:1.3f};\tAcc: {3:1.3f};\tPercent: {4:1.2f}%'.format(epoch+1, 50, running_loss / len(train_loader), accuracy,(100*place)/700, step+1, steps))
