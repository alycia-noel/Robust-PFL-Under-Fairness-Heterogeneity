...
def plot_roc_curves(results, pred_col, resp_col, c, size=(7, 5), fname=None):
    ...
    title_roc = 'ROC for LR on COMPAS - Client '+ str(c + 1)
    plt.title(title_roc)
...
for c in range(clients):
    ...
    for epoch in range(100):
        ...
        #print('Client: {5};\tEpoch: {0}/{1};\t Loss: {2:1.3f};\tAcc:{3:1.3f};\tTime:{4:1.2f}'.format(epoch + 1, 100, running_loss / len(train_loader), accuracy, elapsed, c))
