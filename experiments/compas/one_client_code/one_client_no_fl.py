    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            for i, (x, y) in enumerate(test_loader):
                ...
                TP, FP, FN, TN, f_tp, f_fp, f_tn, f_fn, m_tp, m_fp, m_tn, m_fn = confusion_matrix(x, predicted_prediction, labels_pred, TP, FP, FN, TN, f_tp, f_fp, f_tn, f_fn, m_tp, m_fp, m_tn, m_fn)
