...
def get_data():
    ...
    client_1 = compas[compas['score_text'] == 0] #1144

    client_2 = compas[compas['score_text'] == 1] #3421

    client_3 = compas[compas['score_text'] == 2] #1607
    ...
    cols_3 = client_3.columns
    features_3, decision_3, sensitive_3 = cols_3[:-2], cols_3[-2], cols_3[-1]

    d_train_1, d_test_1 = train_test_split(client_1, test_size=128)
    ...
    d_train_2, d_test_2 = train_test_split(client_2, test_size=128)
    ...
    d_train_3, d_test_3 = train_test_split(client_3, test_size=128)
    data_train_3 = TabularData(d_train_3[features_3].values, d_train_3[decision_3].values, d_train_3[sensitive_3].values)
    data_test_3 = TabularData(d_test_3[features_3].values, d_test_3[decision_3].values, d_test_3[sensitive_3].values)

    return data_train_1, data_test_1, data_train_2, data_test_2, data_train_3, data_test_3, features_1, features_2, features_3, decision_1, decision_2, decision_3, d_test_1, d_test_2, d_test_3, encoders

def confusion_matrix(x, predicted_prediction, labels_pred, TP, FP, FN, TN, f_tp, f_fp, f_tn, f_fn, m_tp, m_fp, m_tn, m_fn):
