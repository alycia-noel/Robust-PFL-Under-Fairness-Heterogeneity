...
def get_data():
    ...
    features_3, decision_3 = cols_3[:-1], cols_3[-1]

    d_train_1, d_test_1 = train_test_split(client_1, test_size=100)
    ...
    d_train_2, d_test_2 = train_test_split(client_2, test_size=100)
    ...
    d_train_3, d_test_3 = train_test_split(client_3, test_size=100)
    data_train_3 = TabularData(d_train_3[features_3].values, d_train_3[decision_3].values)
    data_test_3 = TabularData(d_test_3[features_3].values, d_test_3[decision_3].values)
